...
class MediaSourceProvider {
  ...
  async getMediaByPathSubstring(substring, mediaType, sortBy) {
    throw new Error('Method getMediaByPathSubstring() must be implemented by subclass');
  }
  ...
  async removeTagFromMedia(mediaId, tagId) {
    throw new Error('Method removeTagFromMedia() must be implemented by subclass');
  }

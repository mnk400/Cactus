  ...
  return (
    <div className="flex items-center gap-2 flex-shrink-0 pointer-events-auto pb-1">
      <button
        ...
        className="flex items-center gap-1.5 h-8 bg-black-shades-700 rounded-xl px-3 text-sm text-white cursor-pointer transition-all duration-200 ease-in-out hover:bg-white hover:bg-opacity-20 active:scale-95"
      ...
      <button
        ...
        className="flex items-center justify-center h-8 w-8 p-2 bg-black-shades-700 rounded-xl text-white cursor-pointer transition-all duration-200 ease-in-out hover:bg-white hover:bg-opacity-20 active:scale-95"
        title="Fullscreen"
      >
        <svg
          className="w-4 h-4"
